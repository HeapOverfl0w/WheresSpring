...
export class Animation {
    constructor(name, image, frameWidth, frameHeight, frameCount, frameTimeMs, repeats) {
        this.name = name;
        this.image = image;
    ...
    copy() {
        return new Animation(this.name, this.image, this.frameWidth, this.frameHeight, this.frameCount, this.frameTimeMs, this.repeats);
    }
}